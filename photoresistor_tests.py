...
#import face_recognition_ERP_protocol_vf as protocol
...
class Graph:
    ...
    def update(self):
        ...
        self.curves[0].setData(ldr) # setData is the method that updates the graph from the initial plot object reference
