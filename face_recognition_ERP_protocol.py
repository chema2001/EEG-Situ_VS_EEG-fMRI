...
while continueRoutine and routineTimer.getTime() < 15.5:
    ...
    # start/stop beep
    if beep.status == NOT_STARTED and tThisFlip >= 15-frameTolerance:
        # keep track of start time/frame for later
...
trial_block = data.TrialHandler(nReps=3.0, method='random', 
...
for thisTrial_block in trial_block:
    ...
    routineTimer.reset()
# completed 3.0 repeats of 'trial_block'
